...
namespace MBv8Web
{
    public partial class Global :  System.Web.HttpApplication
    {
        ...
        void RegisterRoutes(RouteCollection routes)
        {
            ...
            routes.MapPageRoute("", "Banking-GLEntry/","~/html/bank-glentry.aspx");
            routes.MapPageRoute("", "Bank-Recon/", "~/html/bank-recon.aspx");
			routes.MapPageRoute("", "Bank-Recon2/", "~/html/bank-recon2.aspx");
            routes.MapPageRoute("", "Bank-Recon2Report/", "~/html/bank-reconrpt.aspx");
            ...
            routes.MapPageRoute("", "Import-Asset/", "~/html/asset-import.aspx");
