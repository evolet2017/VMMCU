                              ...
                              <div class="form-group">
                                  ...
                                  <script>
                                      if(MB.getParameterByName('pass_amt') === ""){
                                          ...
                                          document.write('<Button class="btn btn-primary" ID="BankSave" onclick="BankDeposit.postcash(this)" >POST CASH</Button>&nbsp;&nbsp;' +
                                            '<Button class="btn btn-danger" onclick="BankDeposit.BAIL();">Cancel</Button>');
                                          document.write('</div>');
                                 
                                          //BankDeposit.postcash(this)
                                      }
                                  </script>
                          ...
                          <div id="tab_2"  class="tab-pane">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <script>
                                          if (MB.getParameterByName('pass_amt') === "") {
                                              document.write('<div class="box-footer">');
                                      document.write('<Button class="btn btn-primary" ID="BankSave" onclick="BankDeposit.postcheck(this)" >POST test2</Button>&nbsp;&nbsp;' + '<Button class="btn btn-danger" onclick="BankDeposit.BAIL();">Cancel</Button>');
                                              document.write('</div>');
                                          }
                                  </script>
                                  </div>
...
<%--                                     
				...
				<div class="box-footer">
		            ...
		            <script>
		                if (MB.getParameterByName("pass_amt") !== "") {
		                    if (MB.getParameterByName("pass_type") === "") {
		                        document.write('<Button class="btn btn-primary" ID="BankSave2" onclick=BankDeposit.postcash("BankSaveMe2") >POST CASH DEPOSIT<Button><Button class="btn btn-danger" onclick="BankDeposit.BAIL()">Cancel</Button>');             
		                    }
