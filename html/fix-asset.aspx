            ...
            <div class="col-md-6">
                           ...
                           <div class="box box-success">
                                ...
                                <div class="box-body">
                                    ...
                                    <input id="assetnum" class="form-control input-sm" type="text" maxlength="20" placeholder="">
...
<%--                                        <label>Description</label> --%>
                                    ...
                                    <div class="form-group">
                                        <label>Asset Entry Type</label>
                                        <p>Note: If asset is purchased date is less than 27 days please select New Entry!</p> 
                                        <select class="form-control" id="entry_type">
                                          <option value="0">New Entry</option>
                                          <option value="1">Old Entry</option>                                
                                        </select>
