						   ...
						   <div class="col-md-10">
                               ...
                               <div class="box">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <input type="text" id="bkfilename" class="form-control" value="<%= "BackUp-"+(DateTime.Now.ToShortDateString()+DateTime.Now.ToShortTimeString()).Replace("/","").Replace(":","").Replace(" ","")+".bak" %>" />
                                        <br />
