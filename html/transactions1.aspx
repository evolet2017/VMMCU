                                        ...
                                        <table class="table table-bordered table-striped dataTable" id="example1" aria-describedby="example1_info">
                                            ...
                                            <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                <%
                                                    ...
                                                    //    "WHERE 1=1 and A.v8RunDate=(select mbvalue from appconfig where mbfield1='sysdate') AND C.Status='01'";                                                 
                                                    //SqlDataReader dr = GenericDB.ExecSQL(connStr, @sql);                                                 
                                                    //Int32 ii = 1;
                                                    //while(dr.Read())
                                                    //{
                                                    //    if(ii!=2)
                                                    //    { Response.Write("<tr class=odd>"); ii = 2; }
                                                    //    else
                                                    //    { Response.Write("<tr class=even>"); ii = 1; }

                                                    //    Response.Write("<td class=' '>"+dr["TrnID"].ToString()+"</td>");
                                                    //    Response.Write("<td class=' sorting_1'>"+dr["Description"].ToString()+"</td>");
                                                    //    Response.Write("<td class=' '>"+dr["Explanation"].ToString()+"</td>");
                                                    //    Response.Write("<td class=' '>$ ");
                                                    //    Response.Write(String.Format("{0:0.00}", Convert.ToDouble(dr["amount"].ToString()) )); //Decimal.Round(Convert.ToDouble(dr["amount"].ToString()),2));
                                                    //    Response.Write("</td>");
                                                    //    if( Convert.ToInt32(dr["status"].ToString()) == 1){
                                                    //        Response.Write("<td class=' ' onclick=checkid('" + dr["TrnID"].ToString() + "')><span class='label label-success'>Posted</span></td>");
                                                    //    }
                                                    //    else { Response.Write("<td class=' ' onclick=checkid('" + dr["TrnID"].ToString() + "')><span class='label label-warning'>Canceled</span></td>"); }

                                                    //    if (dr["CheckNumber"].ToString() == "0")
                                                    //    {
                                                    //        Response.Write("<td class=' '>" + dr["Reference"].ToString() + "</td>");
                                                    //    }
                                                    //    else 
                                                    //    {
                                                    //        Response.Write("<td class=' '> Check# " + dr["CheckNumber"].ToString() + "</td>");
                                                    //    }
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $.each(JSON.parse(result), function (key, value) {
                        ...
                        if (value.status == 1) { 
                            tr += "<td class=' ' onclick=checkid('" + value.TrnID + "')><span class='label label-success'>Posted</span></td>";
                        } else {
                            tr += "<td class=' ' onclick=checkid('" + value.TrnID + "')><span class='label label-warning'>Canceled</span></td>"
                        }
