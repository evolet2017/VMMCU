    ...
    <body class="skin-black">
						   ...
						   <div class="col-xs-12">
                               ...
                               <div class="box">
							    <div class="box-header">
                                    ...
                                    <button type="button" id="singlerpt" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> Printer Friendly</button>      
                                    </span>                      
                                </div><!-- /.box-header -->
        ...
        <script type="text/javascript">
            ...
            function loadtrans() {
                ...
                bootbox.hideAll();
                console.log('sp_PostedTransactions');

                $.ajax({
                    type: "post",
                    url: MB.URLPoster(),
                    //data: { SQLStatement: sql },
                    data: { SQLStatement: 'sp_PostedTransactions' },
            ...
            $('#singlerpt').click(function () {
		//alert('test');
                window.open("transactionrpt.html");
                console.log('click');
            });
