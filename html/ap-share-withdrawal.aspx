...
<html>
  <head>
    ...
    <!-- bootstrap 3.0.2 -->
        ...
        <link href="/html/css/nprogress.css" rel="stylesheet" type="text/css" />
        ...
        <script src="/html/js/nprogress.js"></script>

        <script src="/html/js/bankshare.js"></script>
  ...
  <div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
      ...
      <section class="content-header">
        <h1>Share Withdrawal</h1>
        <ol class="breadcrumb">
          <li>
            <a href="/Main">Dashboard</a>
          </li>
          <li class="active">Share Withdrawal</li>
        </ol>
      </section>
      <!-- Main content -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"><i class="fa fa-dollar"></i> Withdrawal Details</h4>
                    </div>
                   
                        <div class="modal-body">
                            <div class="form-group">
                                <label for="" class="text-blue">Select Bank Account</label> 
                                <select class="form-control input-lg text-green" id="frmShareSelect"  onchange="BankShare.bankshareinfo(this.value)">                                                                  
                                </select>
                            ...
                            <div class="form-group">
							        ...
							        <input type="text" id="checkAmount" placeholder="" class="form-control numbersOnly" readonly="true">
					        </div>
                        ...
                        <div class="modal-footer clearfix">
                            ...
                            <button type="submit" id="postit" class="btn btn-primary pull-left" onclick="BankShare.banksharesave();"><i class="fa  fa-thumbs-o-up"></i> Post Entry</button>
                        </div>
 ...
 <script src="/html/js/bootstrap.min.js" type="text/javascript"></script>
	   ...
	   MB.push("sp_GetPayables");      
           ...
           BankShare.banksharebanklist();
    	   //BankShare.bankshareinfo($('#frmShareSelect').val());
           BankShare.bankshareload();
