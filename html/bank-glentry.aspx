...
<html>
    ...
    <body class="skin-black">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Bank Account Adjusting Entry</li>
                    </ol>
                </section>
						   ...
						   <div class="col-md-12">
                               ...
                               <div class="box">
                                    <div class="box-header">
                                        <blockquote>
                                            <h4>Bank Account Adjusting Entry</h4>
                                        </blockquote>
                                    ...
                                    <div class="box-body">
                                       ...
                                       <%-- <div id="the-basics">
                                        ...
                                        <select class="form-control chosen-select" id="gBankGL">
                                        </select>
        ...
        <script>
           ...
           var retval  = $.post(MB.URLPoster(), { SQLStatement: "select BankName,BankAccountNum,BankAccountType,GLACC,dbo.TRIM(cast(BankAccountType as varchar))+':'+GLACC as idkey  from BankAccounts" });
           retval.success(function(data){
              $.each(JSON.parse(data), function(key,value){
                  TITLE = value.BankName + ' - (ACCT# '+value.BankAccountNum+')';
                $('#gBankGL').append("<option value='" + value.idkey + "'>" + TITLE + "</option>");                    
              }); 
             $('#gBankGL').chosen({ width: "99%" });  
            });


            $('#btnsv').click( function () {
                radio = document.getElementsByName('r2')[0].checked,
                glacct =  ($('#gBankGL').val()).split(':')[1],
                glcredit = $('#gCredit').val();
                
                
                console.log('R1 : '+radio);
                console.log(glacct);
               ...
               // return;
                ...
                // 1. insert data to recon table (bankrecon2) - pass this one.. proceed to no#2
                // 2. insert data to MasterTRN
                // 3. insert data to BankAccTrn (debit/credit)
                // 4. note about recalculation - be careful with BankAccTrn recalculate, this may cause problem in bankrecon
