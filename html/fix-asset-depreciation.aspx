        ...
        <div class="row">
            ...
            <div class="box box-solid">
                <div class="box-header">
                    <!-- h2 class="box-title">Depreciation Report</!-->
                ...
                <div class="box-body" style="height:600px">
                    <script>
                        ...
                        document.write('<object width="100%" height="100%" type="application/pdf" data="' + rpturl + 'view=1&report=depreciation.rpt" id="pdf_content">' +
